        ...
        <div className={`w-[1480px] h-[289px] gap-[100px] ${inter} flex flex-col`}>
            <div className='w-[1480px] h-[169px] gap-[100px] flex '>
                <div className='w-[295px] h-[169px]gap-[15px]'>
                    ...
                    <p className='w-[240px] h-[120px] text-lg mt-6 font-normal leading-[30px] tracking-[-2%]text-left text-white'>whitepace was created for the new ways we live and work. We make a better workspace around the world</p>
                </div>
